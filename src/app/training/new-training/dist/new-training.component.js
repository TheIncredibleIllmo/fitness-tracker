...
var NewTrainingComponent = /** @class */ (function () {
    function NewTrainingComponent(traningService) {
        this.traningService = traningService;
        this.trainings = [];
        this.trainingStart = new core_1.EventEmitter();
    }
    NewTrainingComponent.prototype.ngOnInit = function () {
        this.trainings = this.traningService.getTranings();
    };
    NewTrainingComponent.prototype.startTraining = function () {
        this.trainingStart.emit();
    };
    __decorate([
        core_1.Output()
    ], NewTrainingComponent.prototype, "trainingStart");
